...
TEST(CalculatorGraph, ObserveOutputStreamError) {
  ...
  ASSERT_THAT(std::string(status.message()), testing::HasSubstr("MagicString-eatnhuea"));
...
TEST(CalculatorGraph, ObserveOutputStreamNonexistent) {
  ...
  EXPECT_THAT(std::string(status.message()), testing::HasSubstr("not_found"));
}
...
TEST(CalculatorGraph, SetExecutorTwice) {
  ...
  EXPECT_THAT(std::string(status.message()), testing::HasSubstr("xyz"));
}
...
TEST(CalculatorGraph, ReservedNameSetExecutor) {
  ...
  EXPECT_THAT(std::string(status.message()), testing::AllOf(testing::HasSubstr("__gpu"),
